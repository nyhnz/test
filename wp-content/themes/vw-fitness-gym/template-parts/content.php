    ...
    if($vw_fitness_gym_theme_lay == 'Default'){ ?>
      <div class="row m-0">
        ...
        <div class="new-text <?php if(has_post_thumbnail()) { ?>col-lg-6 col-md-6"<?php } else { ?>col-lg-12 col-md-12"<?php } ?>>
          ...
          <?php if( get_theme_mod( 'vw_fitness_gym_toggle_postdate',true) != '' || get_theme_mod( 'vw_fitness_gym_toggle_author',true) != '' || get_theme_mod( 'vw_fitness_gym_toggle_comments',true) != '') { ?>
            <div class="post-info">
              <?php if(get_theme_mod('vw_fitness_gym_toggle_postdate',true)==1){ ?>
                <i class="fas fa-calendar-alt"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_fitness_gym_archive_year, $vw_fitness_gym_archive_month, $vw_fitness_gym_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span>|</span>
              <?php } ?>
              ...
              <?php if(get_theme_mod('vw_fitness_gym_toggle_comments',true)==1){ ?>
                <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-fitness-gym'), __('0 Comments', 'vw-fitness-gym'), __('% Comments', 'vw-fitness-gym') ); ?> </span>
              <?php } ?>
              <hr>
            </div>
          <?php } ?>
            ...
            <p>
              ...
              if($vw_fitness_gym_theme_lay == 'Excerpt'){ ?>
                <?php if(get_the_excerpt()) { ?>
                  <p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_fitness_gym_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_fitness_gym_excerpt_number','30')))); ?> <?php echo esc_html(get_theme_mod('vw_fitness_gym_excerpt_suffix',''));?></p>
                <?php }?>
              <?php }?>
            </p>
          </div>
